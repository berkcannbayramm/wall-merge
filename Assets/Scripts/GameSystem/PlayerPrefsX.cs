...
namespace BBGameStudios.Managers
{
	public class PlayerPrefsX
	{
		...
		public static bool SetBoolArray(String key, bool[] boolArray)
		{
			...
			bytes[0] = global::System.Convert.ToByte(ArrayType.Bool);   // Identifier
		...
		public static bool[] GetBoolArray(String key)
		{
			if (PlayerPrefs.HasKey(key))
			{
				var bytes = global::System.Convert.FromBase64String(PlayerPrefs.GetString(key));
				if (bytes.Length < 5)
				{
				...
				global::System.Array.Copy(bytes, 5, bytes2, 0, bytes2.Length);
		...
		public static bool SetStringArray(String key, String[] stringArray)
		{
			...
			bytes[0] = global::System.Convert.ToByte(ArrayType.String); // Identifier
			Initialize();
			...
			try
			{
				PlayerPrefs.SetString(key, global::System.Convert.ToBase64String(bytes) + "|" + String.Join("", stringArray));
			}
			catch
			{
				return false;
		...
		public static String[] GetStringArray(String key)
		{
			if (PlayerPrefs.HasKey(key))
			{
				...
				var bytes = global::System.Convert.FromBase64String(completeString.Substring(0, separatorIndex));
		...
		private static bool SetValue<T>(String key, T array, ArrayType arrayType, int vectorNumber, Action<T, byte[], int> convert) where T : IList
		{
			...
			bytes[0] = global::System.Convert.ToByte(arrayType);    // Identifier
			Initialize();
		...
		private static bool SaveBytes(String key, byte[] bytes)
		{
			try
			{
				PlayerPrefs.SetString(key, global::System.Convert.ToBase64String(bytes));
			}
			catch
			{
				return false;
		...
		{
			byteBlock = global::System.BitConverter.GetBytes(f);
		...
		private static float ConvertBytesToFloat(byte[] bytes)
		{
			...
			return global::System.BitConverter.ToSingle(byteBlock, 0);
		}

		private static void ConvertInt32ToBytes(int i, byte[] bytes)
		{
			byteBlock = global::System.BitConverter.GetBytes(i);
			ConvertTo4Bytes(bytes);
		}
		...
		{
			ConvertFrom4Bytes(bytes);
			return global::System.BitConverter.ToInt32(byteBlock, 0);
		}
